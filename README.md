...
The board is a compile-time feature (`board-x4` default, or `board-x3`); pass
`--no-default-features --features board-x3` to run the firmware, native
emulator, or preview for the X3. The browser emulator builds one wasm per
board:
